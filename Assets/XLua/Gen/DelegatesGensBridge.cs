...
namespace XLua
{
    public partial class DelegateBridge : DelegateBridgeBase
    {
		...
		public void __Gen_Delegate_Imp6(CallBackArgs p0)
		{
#if THREAD_SAFT || HOTFIX_ENABLE
            lock (luaEnv.luaEnvLock)
            {
		...
		public override Delegate GetDelegateByType(Type type)
		{
			...
			{
			    return new UIMultiScroller.OnItemCreateHandler(__Gen_Delegate_Imp0);
			}
		
		    if (type == typeof(SocketDispatcher.OnActionHandle))
			{
			    return new SocketDispatcher.OnActionHandle(__Gen_Delegate_Imp1);
			}
		
		    if (type == typeof(UIDispatcher.OnActionHandle))
			{
			    return new UIDispatcher.OnActionHandle(__Gen_Delegate_Imp2);
			}
		
		    if (type == typeof(DelegateDefine.OnMessageShow))
			{
			    return new DelegateDefine.OnMessageShow(__Gen_Delegate_Imp3);
			}
		
		    if (type == typeof(DelegateDefine.OnViewHide))
			{
			    return new DelegateDefine.OnViewHide(__Gen_Delegate_Imp3);
			}
		
		    if (type == typeof(DelegateDefine.OnMessageOK))
			{
			    return new DelegateDefine.OnMessageOK(__Gen_Delegate_Imp3);
			}
		
		    if (type == typeof(DelegateDefine.OnMessageCancel))
			{
			    return new DelegateDefine.OnMessageCancel(__Gen_Delegate_Imp3);
			}
		    ...
		    if (type == typeof(DelegateDefine.OnChooseCount))
			{
			    return new DelegateDefine.OnChooseCount(__Gen_Delegate_Imp4);
			}
		
		    if (type == typeof(LuaViewBehaviour.delLuaAwake))
			{
			    return new LuaViewBehaviour.delLuaAwake(__Gen_Delegate_Imp5);
			}
		
		    if (type == typeof(LuaWindowBehaviour.delLuaAwake))
			{
			    return new LuaWindowBehaviour.delLuaAwake(__Gen_Delegate_Imp5);
			}
		
		    if (type == typeof(XLuaCustomExport.OnCreate))
			{
			    return new XLuaCustomExport.OnCreate(__Gen_Delegate_Imp5);
			}
		
		    if (type == typeof(XLuaCustomExport.NetWorkSendDataCallBack))
			{
			    return new XLuaCustomExport.NetWorkSendDataCallBack(__Gen_Delegate_Imp6);
			}
		
		    if (type == typeof(LuaHelper.delLuaLoadView))
			{
			    return new LuaHelper.delLuaLoadView(__Gen_Delegate_Imp7);
			}
			...
			{
			    return new __Gen_Hotfix_Delegate0(__Gen_Delegate_Imp21);
			}
		
		    if (type == typeof(__Gen_Hotfix_Delegate1))
			{
			    return new __Gen_Hotfix_Delegate1(__Gen_Delegate_Imp22);
			}
		
		    if (type == typeof(__Gen_Hotfix_Delegate2))
			{
			    return new __Gen_Hotfix_Delegate2(__Gen_Delegate_Imp23);
			}
		
		    if (type == typeof(__Gen_Hotfix_Delegate3))
			{
			    return new __Gen_Hotfix_Delegate3(__Gen_Delegate_Imp24);
			}
		
		    if (type == typeof(__Gen_Hotfix_Delegate4))
			{
			    return new __Gen_Hotfix_Delegate4(__Gen_Delegate_Imp25);
			}
		
		    if (type == typeof(__Gen_Hotfix_Delegate5))
			{
			    return new __Gen_Hotfix_Delegate5(__Gen_Delegate_Imp26);
			}
		
		    if (type == typeof(__Gen_Hotfix_Delegate6))
			{
			    return new __Gen_Hotfix_Delegate6(__Gen_Delegate_Imp27);
			}
		
		    if (type == typeof(__Gen_Hotfix_Delegate7))
			{
			    return new __Gen_Hotfix_Delegate7(__Gen_Delegate_Imp28);
			}
		
		    if (type == typeof(__Gen_Hotfix_Delegate8))
			{
			    return new __Gen_Hotfix_Delegate8(__Gen_Delegate_Imp29);
			}
		
		    if (type == typeof(__Gen_Hotfix_Delegate9))
			{
			    return new __Gen_Hotfix_Delegate9(__Gen_Delegate_Imp30);
			}
		
		    if (type == typeof(__Gen_Hotfix_Delegate10))
			{
			    return new __Gen_Hotfix_Delegate10(__Gen_Delegate_Imp31);
			}
		
		    if (type == typeof(__Gen_Hotfix_Delegate11))
			{
			    return new __Gen_Hotfix_Delegate11(__Gen_Delegate_Imp32);
			}
		
		    if (type == typeof(__Gen_Hotfix_Delegate12))
			{
			    return new __Gen_Hotfix_Delegate12(__Gen_Delegate_Imp33);
			}
		
		    if (type == typeof(__Gen_Hotfix_Delegate13))
			{
			    return new __Gen_Hotfix_Delegate13(__Gen_Delegate_Imp34);
			}
		
		    if (type == typeof(__Gen_Hotfix_Delegate14))
			{
			    return new __Gen_Hotfix_Delegate14(__Gen_Delegate_Imp35);
			}
		
		    if (type == typeof(__Gen_Hotfix_Delegate15))
			{
			    return new __Gen_Hotfix_Delegate15(__Gen_Delegate_Imp36);
			}
		
		    if (type == typeof(__Gen_Hotfix_Delegate16))
			{
			    return new __Gen_Hotfix_Delegate16(__Gen_Delegate_Imp37);
			}
		
		    if (type == typeof(__Gen_Hotfix_Delegate17))
			{
			    return new __Gen_Hotfix_Delegate17(__Gen_Delegate_Imp38);
			}
