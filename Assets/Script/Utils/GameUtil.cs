...
public class GameUtil
{
    ...
    public static Sprite LoadGameLevelDetailIco(string picName)
    {
        return Resources.Load(string.Format("UI/GameLevel/GameLevelDetail/{0}", picName), typeof(Sprite)) as Sprite;
    }
    public static Sprite LoadWorldMapIco(string picName)
    {
        return Resources.Load(string.Format("UI/WorldMap/{0}", picName), typeof(Sprite)) as Sprite;
    }

    public static Sprite LoadGameLevelGoodsImg(int goodId,GoodsType type)
    {
        ...
        return Resources.Load(string.Format("UI/{0}/{1}", path, goodId), typeof(Sprite)) as Sprite;
    }
