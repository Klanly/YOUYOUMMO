    ...
    public class XLua_Gen_Initer_Register__
	{
	    static XLua_Gen_Initer_Register__()
        {
		    XLua.LuaEnv.AddIniter((luaenv, translator) => {
				...
				translator.DelayWrapLoader(typeof(ConstDefine), ConstDefineWrap.__Register);
				...
				translator.DelayWrapLoader(typeof(MessageViewType), MessageViewTypeWrap.__Register);
				
				translator.DelayWrapLoader(typeof(GlobalInit), GlobalInitWrap.__Register);
				...
				translator.DelayWrapLoader(typeof(MessageCtrl), MessageCtrlWrap.__Register);
				
				translator.DelayWrapLoader(typeof(UIViewUtil), UIViewUtilWrap.__Register);
